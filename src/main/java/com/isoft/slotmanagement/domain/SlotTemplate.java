...
public class SlotTemplate implements Serializable {
    ...
    @OneToMany(mappedBy = "slotTemplate")
    private Set<SlotInstance> slots = new HashSet<>();
    ...
    public SlotTemplate dayStartTime(ZonedDateTime dayStartTime) {
    ...
    public SlotTemplate dayEndTime(ZonedDateTime dayEndTime) {
    ...
    public Set<SlotInstance> getSlots() {
        return slots;
    }

    public SlotTemplate slots(Set<SlotInstance> slotInstances) {
        this.slots = slotInstances;
        return this;
    }

    public SlotTemplate addSlots(SlotInstance slotInstance) {
        this.slots.add(slotInstance);
        slotInstance.setSlotTemplate(this);
        return this;
    }

    public SlotTemplate removeSlots(SlotInstance slotInstance) {
        this.slots.remove(slotInstance);
        slotInstance.setSlotTemplate(null);
        return this;
    }

    public void setSlots(Set<SlotInstance> slotInstances) {
        this.slots = slotInstances;
    }
