package com.isoft.slotmanagement.web.rest;

import com.isoft.slotmanagement.SlotManagementApp;
import com.isoft.slotmanagement.config.SecurityBeanOverrideConfiguration;
import com.isoft.slotmanagement.domain.SlotTemplate;
import com.isoft.slotmanagement.repository.SlotTemplateRepository;
import com.isoft.slotmanagement.service.SlotTemplateService;
import com.isoft.slotmanagement.service.dto.SlotTemplateDTO;
import com.isoft.slotmanagement.service.mapper.SlotTemplateMapper;
import com.isoft.slotmanagement.web.rest.errors.ExceptionTranslator;
...
import static com.isoft.slotmanagement.web.rest.TestUtil.sameInstant;
import static com.isoft.slotmanagement.web.rest.TestUtil.createFormattingConversionService;
...
public class SlotTemplateResourceIT {
    ...
    private static final ZonedDateTime DEFAULT_DAY_START_TIME = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_DAY_START_TIME = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public void getAllSlotTemplates() throws Exception {
        ...
        restSlotTemplateMockMvc.perform(get("/api/slot-templates?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dayStartTime").value(hasItem(sameInstant(DEFAULT_DAY_START_TIME))))
    ...
    public void getSlotTemplate() throws Exception {
        ...
        restSlotTemplateMockMvc.perform(get("/api/slot-templates/{id}", slotTemplate.getId()))
            ...
            .andExpect(jsonPath("$.dayStartTime").value(sameInstant(DEFAULT_DAY_START_TIME)))
