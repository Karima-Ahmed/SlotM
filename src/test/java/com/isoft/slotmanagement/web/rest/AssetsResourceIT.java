...
import com.isoft.slotmanagement.repository.AssetsRepository;
import com.isoft.slotmanagement.service.AssetsService;
import com.isoft.slotmanagement.service.dto.AssetsDTO;
import com.isoft.slotmanagement.service.mapper.AssetsMapper;
...
public class AssetsResourceIT {
    ...
    private static final BigDecimal DEFAULT_REF_ID = new BigDecimal(1);
    private static final BigDecimal UPDATED_REF_ID = new BigDecimal(2);
    ...
    public void createAssets() throws Exception {
        ...
        assertThat(testAssets.getRefId()).isEqualTo(DEFAULT_REF_ID);
    }
    ...
    public void updateAssets() throws Exception {
        ...
        assertThat(testAssets.getRefId()).isEqualTo(UPDATED_REF_ID);
    }
